...
//        System.out.println("0th item: "+ list.getValue(0));
        ...
        list.insert(2, 5);
        System.out.println("list should be 4 2 5 7 71 6: " +  list); // 4 2 5 7 71 6
        list.remove(3);
        System.out.println("list should be 4 2 5 71 6: " +  list); // 4 2 5 71 6
...
//        System.out.println("Value of index 6 should be -1: " + list.getValue(6));
//
//        list.insert(3, 10);
